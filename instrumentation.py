...
class ASINetwork(object):
    ...
    def __init__(self, name=None, elev=None, color=None, alt=None, sites=None):
        ...
        self.sites = [ASI(**site, elev=elev, alt=alt) for site in sites]

#    def plot(self, ax):
#
#        for site in self.sites:
#            glat, glon = site.generate_fov(self.elev, self.alt)
#            ax.plot(glon, glat, transform=ccrs.Geodetic())



class ASI(object):
    def __init__(self, name=None, glat=None, glon=None, elev=None, alt=None):
        self.site_lat = glat
        self.site_lon = glon
        self.site_alt = 0.
#        self.color = color
...
class FPINetwork(object):
    ...
    def __init__(self, name=None, elev=None, color=None, alt=None, sites=None):
        self.label = name
        self.color = color
        self.sites = [FPI(**site, elev=elev, alt=alt) for site in sites]
...
class AMISR(object):
    ...
    def __init__(self, name=None, radar=None, alt=None, color=None):
    ...
    def generate_fov(self, az, el):
        lat, lon, alt = projected_beam(self.site_lat, self.site_lon, 0., az, el, proj_alt=450)
        return lat[::-1], lon[::-1]

class ISR(object):
    def __init__(self, name=None, glat=None, glon=None, elev=None, alt=None, color=None):
        self.site_lat = glat
        self.site_lon = glon
        self.color = color
...
class SDNetwork(object):
    def __init__(self, name=None, color=None, radars=None):
        self.color = color
